...
class SignUpForm(UserCreationForm):
	...
	class Meta:
		model = User
		fields = ('username', 'firstname', 'lastname', 'email', 'password', 'cpassword')
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['cpassword'].widget.attrs['class'] = 'form-control'
		self.fields['cpassword'].widget.attrs['placeholder'] = 'Confirm Password'
		self.fields['cpassword'].label = ''
		self.fields['cpassword'].help_text = '<span class="form-text text-muted"><small>Enter the same password as before, for verification.</small></span>'	
